...
const ExportHousePriceCSV = (props) => {
    ...
    useEffect(() => {
        ...
        axios({
            url: apiUrl + 'houseprice/export', //your url
            method: 'GET',
            ...
            link.href = url;
            link.setAttribute('download', 'housePriceExport.csv'); //or any other extension
            ...
            { uiLoading ? (<main className={classes.content}>
                ...
                : (<main className={classes.content}>
                        ...
                        <Card {...rest} className={clsx(classes.root, classes)}>
                            <CardContent>
                                Download CSV file of House Price Query history
...
export default withStyles(styles)(ExportHousePriceCSV);